export const LandingData = {
    ...
    hook: {
        title: '¿Disfrutas de la “Coctelería de Autor” y te gustaría replicar los sabores de tu bar favorito?',
        content: 'Si las respuestas son afirmativas éste es el curso perfecto para ti.' +
            '<br/>' +
            '<br/>' +
            'Muchos hablan de la coctelería de autor y pareciera que hay que estudiar 20 años para preparar un trago ' +
            'decente en casa. Pero te contamos que esto no es así.' +
            '<br/>' +
            '<br/>' +
            'Vamos a partir de la base de la coctelería clásica porque para avanzar en la coctelería de autor debes ' +
            'conocer lo clásico.Esa será tu primera parte.' +
            'Luego pasaremos de lleno a la creación del “Cóctel de Autor”.' +
            '<br/>' +
            '<br/>' +
        ...
        steps: [
            {
                ...
                items: [
                    'Entrevista al profesor Rodrigo Muñoz',
                    'Bienvenida al curso de Coctelería de Autor',
                    'Mixología',
                    'Barman',
                    'Herramientas',
                    'Cristalería',
            ...
            {
                title: 'Módulo 2 - Botellas del mercado clásicas',
                items: [
                    'Pisco',
                    'Ginebra',
                    'Vodka',
            ...
            {
                title: 'Módulo 3 - dominando la coctelería clásica',
                items: [
                    'Bloody Mary',
                    'Clover club',
                    'Oscuro y tormentoso',
            ...
            {
                title: 'Módulo 4 - dominando la coctelería de autor',
                items: [
                    'Paloma',
                    'Spritz veneziano',
                    'Caramelito',
    ...
    faq: {
        ...
        items: [
            {
                question: '¿Tengo acceso ilimitado a este curso?',
